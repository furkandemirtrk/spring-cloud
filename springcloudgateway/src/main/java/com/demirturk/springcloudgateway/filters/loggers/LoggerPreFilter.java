...
public class LoggerPreFilter extends AbstractGatewayGlobalFilterFactory {
    ...
    @Override
    public void applyBeforeRoute(ServerWebExchange exchange, GatewayFilterChain chain){
    ...
    @Override
    public int getOrder(){
        return FilterRegistry.getOrder(LoggerPreFilter.class);
    }
